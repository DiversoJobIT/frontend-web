    ...
    <section className="bg-white py-16 sm:py-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="text-left  mb-16">
          <h2 className="text-3xl sm:text-4xl font-bold text-[#0a59a3]">¿Cómo funciona?</h2>
          ...
          <div className="space-y-10">
            {steps.map((step, index) => (
              <div key={index} className="flex gap-4 relative">
                <div className="shrink-0 w-16 h-16 rounded-full bg-green-50 flex items-center justify-center">
                  {step.icon}
                </div>
                <div className="pt-1">
        ...
        <div className="text-left mt-12 lg:mt-16">
          <a
            href="/register"
            type="button"
            className="inline-flex items-center px-8 py-4 bg-green-600 text-white font-semibold text-lg rounded-xl hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 transition-colors"
          >
            Empezar ahora
          </a>
        </div>
